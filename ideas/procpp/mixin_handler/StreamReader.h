...
public:
    ...
    virtual void read_size(size_t size, string& result) = 0;
    virtual void read_size_offset(size_t size, void* p, size_t offset) = 0;
...
public:
    ...
    virtual void read_size(size_t size, void* p = nullptr/*result ignored, not used*/) override;
    virtual void read_size(size_t size, string& result) override;
    //not used
    virtual void read_size_offset(size_t size, void* p, size_t offset) override;
