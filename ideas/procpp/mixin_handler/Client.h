...
public:
    ...
    virtual int connect_ssl(string address, uint16_t port, EventManager::EventCB callbacks, bool async) = 0;
    virtual int connect(string address, uint16_t port, EventManager::CB::C connect_callback, bool async) = 0;
    virtual int connect(string address, uint16_t port, EventManager::EventCB callbacks, bool async, bool ssl) = 0;
...
public:
    ...
    virtual int connect_ssl(string address, uint16_t port, EventManager::EventCB callbacks, bool async) override;
    virtual int connect(string address, uint16_t port, EventManager::CB::C connect_callback, bool async) override;
    virtual int connect(string address, uint16_t port, EventManager::EventCB callbacks, bool async, bool ssl) override;
